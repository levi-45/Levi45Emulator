...
wget -q --no-check-certificate "https://raw.githubusercontent.com/levi-45/Multicam/main/Cams_ipk/All/enigma2-plugin-softcams-oscam-emu-levi45_*_all.ipk" -O /tmp/OscamEmu.ipk
